...
INSERT INTO `tb_setup` (`user_id`, `seq`, `symbol`, `wait_p`, `gap_p`, `close_p`, `sw_max`, `sw_min`, `fsp_p`, `stoploss_p`, `lot_p`, `lev_p`, `userclose_p`, `order_active`, `over_bolling`, `trend_sty`, `bb_sty`) VALUES
(1001, 1, 'ETHUSDT', 3, 4, 3, 32, 10, 20, 15, 0.4, 20, 1, 1, 0, 'Y', 'N'),
(1001, 2, 'ETHBUSD', 3, 4, 3, 35, 10, 15, 10, 0.01, 20, 1, 0, 5, 'N', 'Y');
...
(1, 0, 0, 1, 0, 1573.68, 1570, 0, 0, 0, 0, 0, 0, 0, '2022-07-25 00:27:07', 0, 0),
...
INSERT INTO `tb_users` (`user_id`, `user_name`, `open_date`, `expire_date`, `line_key`, `api_key`, `api_secret`) VALUES
(1001, 'winbot', '2022-07-01', '2024-07-30', 'WGZnLUvQwVuyFxb587s99aMqIGlMRGKQdDozpYSplfV', 'UAcHPuDF9Wc43v67upj4tK4aQIQCsAaNne1RjfYckHoiPbIPtOKO48voM6CxdHDq', 'EicHVzapiCkcAnchClS8NSpN2fAvrx2yXcG6wfhEFOQfdeNZAERpemtwwX2u3StV');
