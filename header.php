		...
		<div class="page  tx-robo">
			...
			<div class="main-navbar hor-menu sticky">
				<div class="container">
					<ul class="nav">
						<li class="nav-item">
							<a class="nav-link" href="Home.php"><i class="ti-home"></i>Home</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="users.php"><i class="fe fe-user"></i>User Management</a>
						</li>
						<li class="nav-item">
							<a class="nav-link with-sub" href=""><i class="ti-wallet"></i>Theme</a>
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="db_update.php?act=up_theme&uid=<?php echo $user_id; ?>&theme=dark">Dark Mode</a>
								</li>
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="db_update.php?act=up_theme&uid=<?php echo $user_id; ?>&theme=light">Light Mode</a>
								</li>
								 
							</ul>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="index.html"><i class="fe fe-box"></i>Software info</a>
						</li>
